...
sub getter {
	...
	$build .= "static " . $type . " _logos_method\$" . $property->group . "\$" . $property->class . "\$" . $name . "\$" . "(" . $property->class . "* __attribute__((unused)) self, SEL __attribute__((unused)) _cmd){";
...
sub setter {
	...
	my $build = "__attribute__((used)) "; # If the property is never accessed, clang's optimizer will remove the getter/setter if this attribute isn't specified
	$build .= "static void _logos_method\$" . $property->group . "\$" . $property->class . "\$" . $name . "\$" . "(" . $property->class . "* __attribute__((unused)) self, SEL __attribute__((unused)) _cmd, " . $type . " arg){ ";
